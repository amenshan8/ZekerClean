    ...
    Alpine.data('app', () => ({
        ...
        translations: {
            "nl": {
                ...
                "services_intro_text": "ZekerClean biedt een breed scala aan professionele schoonmaakdiensten, perfect afgestemd op uw specifieke behoeften.",
                "service_office_cleaning_heading": "Kantoorschoonmaak",
                "service_office_cleaning_text": "Een schone werkplek draagt bij aan een prettige sfeer en productiviteit. Wij zorgen voor representatieve kantoren, vergaderruimtes en algemene ruimtes.",
                "service_periodic_maintenance_heading": "Periodiek onderhoud",
                "service_periodic_maintenance_text": "Of het nu dagelijks, wekelijks of maandelijks is: wij stemmen onze schoonmaakmomenten af op uw planning en wensen.",
                "service_deep_cleaning_heading": "Dieptereiniging",
                "service_deep_cleaning_text": "Voor intensieve schoonmaak van bijvoorbeeld vloeren, sanitair of keukens zorgen wij dat alles weer grondig en hygiënisch schoon is.",
                "service_delivery_cleaning_heading": "Opleveringsschoonmaak",
                "service_delivery_cleaning_text": "Na een verbouwing, renovatie of verhuizing zorgen wij voor een grondige schoonmaak van de ruimtes. Wij verwijderen bouwstof, vuil en resten, zodat het pand fris en direct gebruiksklaar is.",
            ...
            "en": {
                ...
                "services_intro_text": "ZekerClean offers a wide range of professional cleaning services, perfectly tailored to your specific needs.",
                "service_office_cleaning_heading": "Office Cleaning",
                "service_office_cleaning_text": "A clean workplace contributes to a pleasant atmosphere and productivity. We ensure presentable offices, meeting rooms, and general areas.",
                "service_periodic_maintenance_heading": "Periodic Maintenance",
                "service_periodic_maintenance_text": "Whether daily, weekly, or monthly: we adapt our cleaning schedule to your planning and wishes.",
                "service_deep_cleaning_heading": "Deep Cleaning",
                "service_deep_cleaning_text": "For intensive cleaning of floors, sanitary facilities, or kitchens, for example, we ensure everything is thoroughly and hygienically clean again.",
                "service_delivery_cleaning_heading": "End-of-Lease Cleaning",
                "service_delivery_cleaning_text": "After a renovation, refurbishment, or move, we provide thorough cleaning of the premises. We remove construction dust, dirt, and residue, so the property is fresh and ready for immediate use.",
            ...
            "ar": {
                ...
                "services_intro_text": "تقدم زيكركلين مجموعة واسعة من خدمات التنظيف الاحترافية، مصممة بشكل مثالي لتلبية احتياجاتكم الخاصة.",
                "service_office_cleaning_heading": "تنظيف المكاتب",
                "service_office_cleaning_text": "مكان عمل نظيف يساهم في جو لطيف وإنتاجية. نحن نضمن مكاتب، غرف اجتماعات، ومناطق عامة ممثلة.",
                "service_periodic_maintenance_heading": "الصيانة الدورية",
                "service_periodic_maintenance_text": "سواء كان يوميًا، أسبوعيًا، أو شهريًا: نحن نكيف جدول التنظيف لدينا مع خطتكم ورغباتكم.",
                "service_deep_cleaning_heading": "التنظيف العميق",
                "service_deep_cleaning_text": "للتنظيف المكثف للأرضيات، المرافق الصحية، أو المطابخ على سبيل المثال، نضمن أن كل شيء نظيف وشامل وصحي مرة أخرى.",
                "service_delivery_cleaning_heading": "تنظيف ما بعد التسليم",
                "service_delivery_cleaning_text": "بعد التجديد، التحديث، أو الانتقال، نقدم تنظيفًا شاملاً للمباني. نزيل غبار البناء، الأوساخ، والبقايا، بحيث يكون العقار جديدًا وجاهزًا للاستخدام الفوري.",
